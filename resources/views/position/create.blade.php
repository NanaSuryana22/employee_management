...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="card card-default">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form id="form_validation" action="{{ route('position.store') }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="form-line">
                                    ...
                                    <input type="text" class="form-control @error('job_title') is-invalid @enderror" name="job_title"
                                        autocomplete="off" required value="{{ old('job_title') }}">
                                </div>
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    ...
                                    <input type="number" class="form-control @error('min_salary') is-invalid @enderror" name="min_salary"
                                     autocomplete="off" required value="{{ old('min_salary') }}">
                                </div>
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    ...
                                    <input type="number" class="form-control @error('max_salary') is-invalid @enderror" name="max_salary"
                                        autocomplete="off" required value="{{ old('max_salary') }}">
                                </div>
...
<script>
    function formatRupiah(angka) {
        ...
        var formattedNumber = new Intl.NumberFormat('id-ID', { style: 'currency', currency: 'IDR' }).format(numberString);
